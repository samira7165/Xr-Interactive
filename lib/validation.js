...
// Zod's built-in .url() only checks that the string is *a* URL — it happily
// accepts javascript:/data: schemes too. These fields get rendered as a raw
// <a href> on an authenticated admin page, so only http(s) is acceptable.
function httpUrl(message) {
...
export const ApplicationSchema = z.object({
  ...
  linkedin: httpUrl('Enter a valid LinkedIn URL').optional().or(z.literal('')),
  resumeUrl: httpUrl('Please upload your CV'),
})
