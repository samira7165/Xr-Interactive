...
export default function SignupForm() {
  ...
  return (
    <form action={formAction} className="admin-card" style={{ width: '320px' }}>
      <h1 style={{ fontSize: '1.2rem', marginBottom: '1.25rem', fontFamily: 'var(--font-display)' }}>Admin Sign Up</h1>
      ...
      <p style={{ marginTop: '1rem', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
        Already have an account? <Link href="/admin/login" style={{ color: 'var(--purple-light)' }}>Log in</Link>
      </p>
      <style>{`
